...
#define OPTIONS_GEN6_XP_SHARE_ON 0
#define OPTIONS_GEN6_XP_SHARE_OFF 1

#define OPTIONS_TYPE_EFFECTIVENESS_SHOW 0
#define OPTIONS_TYPE_EFFECTIVENESS_HIDE 1

#define OPTIONS_MATCH_CALLS_ON 0
#define OPTIONS_MATCH_CALLS_OFF 1
