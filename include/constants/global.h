...
#define OPTIONS_GEN6_XP_SHARE_OFF 0
#define OPTIONS_GEN6_XP_SHARE_ON 1

#define OPTIONS_TYPE_EFFECTIVENESS_HIDE 0
#define OPTIONS_TYPE_EFFECTIVENESS_SHOW 1

#define OPTIONS_MATCH_CALLS_OFF 0
#define OPTIONS_MATCH_CALLS_ON 1
