...
static const u8 sSpeciesToBackAnimSet[NUM_SPECIES] =
{
    ...
    [SPECIES_MAKUHITA]   = BACK_ANIM_V_SHAKE_LOW, // Monodramon
    [SPECIES_HARIYAMA]   = BACK_ANIM_V_SHAKE_LOW, // Strikedramon
...
#endif
{
    ...
    [SPECIES_ABRA - 1]          = ANIM_V_SQUISH_AND_BOUNCE,
    ...
    [SPECIES_GEODUDE - 1]       = ANIM_V_SQUISH_AND_BOUNCE, // Gottsumon
    [SPECIES_GRAVELER - 1]      = ANIM_V_STRETCH, // Golemon
    ...
    [SPECIES_GOLDEEN - 1]       = ANIM_V_SQUISH_AND_BOUNCE, // Gizamon
    [SPECIES_SEAKING - 1]       = ANIM_V_SLIDE_WOBBLE, // Tortamon
