...
const u8 gMonIconPaletteIndices[] =
{
    ...
    [SPECIES_IVYSAUR] = 4,
    [SPECIES_VENUSAUR] = 4,
    [SPECIES_CHARMANDER] = 1,   // Agumon
    [SPECIES_CHARMELEON] = 3,   // GeoGreymon
    [SPECIES_CHARIZARD] = 3,    // RizeGreymon
    [SPECIES_SQUIRTLE] = 0,
    [SPECIES_WARTORTLE] = 2,
    [SPECIES_BLASTOISE] = 2,
    [SPECIES_CATERPIE] = 1,
    ...
    [SPECIES_VULPIX] = 5,
    [SPECIES_NINETALES] = 3,
    [SPECIES_JIGGLYPUFF] = 4, // Gatomon
    [SPECIES_WIGGLYTUFF] = 5, // Angewomon
    [SPECIES_ZUBAT] = 3,    // DemiDevimon
    [SPECIES_GOLBAT] = 3,   // Devimon
    [SPECIES_ODDISH] = 4,   // Floramon
    [SPECIES_GLOOM] = 0,    // Vegimon
    [SPECIES_VILEPLUME] = 0,// Blossomon
    [SPECIES_PARAS] = 0,
    [SPECIES_PARASECT] = 0,
    [SPECIES_VENONAT] = 2,
    [SPECIES_VENOMOTH] = 2,
    ...
    [SPECIES_POLIWHIRL] = 0,
    [SPECIES_POLIWRATH] = 0,
    [SPECIES_ABRA] = 0,     // Renamon
    [SPECIES_KADABRA] = 3,  // Kyubimon
    [SPECIES_ALAKAZAM] = 0, // Taomon
    [SPECIES_MACHOP] = 0,   // Gaomon
    [SPECIES_MACHOKE] = 3,  // Gaogamon
    [SPECIES_MACHAMP] = 3,  // MachGaogamon
    [SPECIES_BELLSPROUT] = 1,
    [SPECIES_WEEPINBELL] = 1,
    [SPECIES_VICTREEBEL] = 1,
    [SPECIES_TENTACOOL] = 4,    // Gesomon
    [SPECIES_TENTACRUEL] = 3,   // MarineDevimon
    [SPECIES_GEODUDE] = 0,      // Gottsumon
    [SPECIES_GRAVELER] = 5,     // Golemon
    [SPECIES_GOLEM] = 1,        // Volcanomon
    [SPECIES_PONYTA] = 3,
    [SPECIES_RAPIDASH] = 3,
    [SPECIES_SLOWPOKE] = 0,
    [SPECIES_SLOWBRO] = 0,
    [SPECIES_MAGNEMITE] = 0,    // Kokuwamon
    [SPECIES_MAGNETON] = 4,     // Mekanorimon
    [SPECIES_FARFETCHD] = 1,
    [SPECIES_DODUO] = 2,
    [SPECIES_DODRIO] = 2,
    [SPECIES_SEEL] = 0,
    ...
    [SPECIES_KRABBY] = 0,
    [SPECIES_KINGLER] = 0,
    [SPECIES_VOLTORB] = 0,  // Terriermon
    [SPECIES_ELECTRODE] = 0,// Gargomon
    [SPECIES_EXEGGCUTE] = 0,
    [SPECIES_EXEGGUTOR] = 1,
    [SPECIES_CUBONE] = 2,
    [SPECIES_MAROWAK] = 2,
    ...
    [SPECIES_HORSEA] = 0,
    [SPECIES_SEADRA] = 0,
    [SPECIES_GOLDEEN] = 5, // Gizamon
    [SPECIES_SEAKING] = 2, // Tortamon
    [SPECIES_STARYU] = 2,
    [SPECIES_STARMIE] = 2,
    [SPECIES_MR_MIME] = 0,
    [SPECIES_SCYTHER] = 1,
    ...
    [SPECIES_PINSIR] = 2,
    [SPECIES_TAUROS] = 2,
    [SPECIES_MAGIKARP] = 1, // Numemon
    [SPECIES_GYARADOS] = 3, // MarineKimeramon
    [SPECIES_LAPRAS] = 2,
    [SPECIES_DITTO] = 2,
    [SPECIES_EEVEE] = 2,
    [SPECIES_VAPOREON] = 0,
    ...
    [SPECIES_SPINARAK] = 1,
    [SPECIES_ARIADOS] = 0,
    [SPECIES_CROBAT] = 3,   // Myotismon
    [SPECIES_CHINCHOU] = 2,
    [SPECIES_LANTURN] = 0,
    [SPECIES_PICHU] = 1,
    [SPECIES_CLEFFA] = 0,
    [SPECIES_IGGLYBUFF] = 0, // Salamon
    [SPECIES_TOGEPI] = 0,
    [SPECIES_TOGETIC] = 0,
    [SPECIES_NATU] = 1,
    [SPECIES_XATU] = 1,
    ...
    [SPECIES_FLAAFFY] = 0,
    [SPECIES_AMPHAROS] = 0,
    [SPECIES_BELLOSSOM] = 1, // Ceresemon Medium
    [SPECIES_MARILL] = 2, // Lunamon
    [SPECIES_AZUMARILL] = 2, // Lekismon
    [SPECIES_SUDOWOODO] = 1,
    [SPECIES_POLITOED] = 1,
    [SPECIES_HOPPIP] = 1,
    [SPECIES_SKIPLOOM] = 1,
    ...
    [SPECIES_TEDDIURSA] = 0,
    [SPECIES_URSARING] = 2,
    [SPECIES_SLUGMA] = 1,   // BlackAgumon
    [SPECIES_MAGCARGO] = 1, // Monochromon
    [SPECIES_SWINUB] = 2,
    [SPECIES_PILOSWINE] = 2,
    [SPECIES_CORSOLA] = 0,
    [SPECIES_REMORAID] = 0,
    ...
    [SPECIES_MARSHTOMP] = 0,
    [SPECIES_SWAMPERT] = 0,
    [SPECIES_POOCHYENA] = 5,// Dracmon
    [SPECIES_MIGHTYENA] = 2,// Sangloupmon
    [SPECIES_ZIGZAGOON] = 1,// Kudamon
    [SPECIES_LINOONE] = 3,  // Reppamon
    [SPECIES_WURMPLE] = 5,  // Minomon
    [SPECIES_SILCOON] = 2,  // Morphomon
    [SPECIES_BEAUTIFLY] = 3,// Hudiemon
    [SPECIES_CASCOON] = 4,  // Wormmon
    [SPECIES_DUSTOX] = 3,   // Stingmon
    [SPECIES_LOTAD] = 5,    // Otamamon
    [SPECIES_LOMBRE] = 1,   // Gekomon
    [SPECIES_LUDICOLO] = 3, // ShogunGekomon
    [SPECIES_SEEDOT] = 5,   // Mushroomon
    [SPECIES_NUZLEAF] = 2,  // Woodmon
    [SPECIES_SHIFTRY] = 5,  // Cherrymon
    [SPECIES_NINCADA] = 3,  // Kunemon
    [SPECIES_NINJASK] = 5,  // Flymon
    [SPECIES_SHEDINJA] = 4, // Shadramon
    [SPECIES_TAILLOW] = 5,  // Hawkmon
    [SPECIES_SWELLOW] = 4,  // Aquilamon
    [SPECIES_SHROOMISH] = 2,// Kotemon
    [SPECIES_BRELOOM] = 2,  // Shurimon
    [SPECIES_SPINDA] = 1,
    [SPECIES_WINGULL] = 0,      // Falcomon
    [SPECIES_PELIPPER] = 5,     // Crowmon
    [SPECIES_SURSKIT] = 5,      // Hyokomon
    [SPECIES_MASQUERAIN] = 5,   // Buraimon
    [SPECIES_WAILMER] = 2,
    [SPECIES_WAILORD] = 0,
    [SPECIES_SKITTY] = 3,   // Labramon
    [SPECIES_DELCATTY] = 5, // Cerberusmon
    [SPECIES_KECLEON] = 1,
    [SPECIES_BALTOY] = 2,
    [SPECIES_CLAYDOL] = 0,
    [SPECIES_NOSEPASS] = 3, // PawnChessmonWhite
    [SPECIES_TORKOAL] = 1,  // DarkTyranomon
    [SPECIES_SABLEYE] = 5,  // Digitamamon
    [SPECIES_BARBOACH] = 0,
    [SPECIES_WHISCASH] = 0,
    [SPECIES_LUVDISC] = 0,
    [SPECIES_CORPHISH] = 0,
    ...
    [SPECIES_FEEBAS] = 2,
    [SPECIES_MILOTIC] = 2,
    [SPECIES_CARVANHA] = 3, // Tylomon
    [SPECIES_SHARPEDO] = 3, // Seahomon
    [SPECIES_TRAPINCH] = 0,
    [SPECIES_VIBRAVA] = 1,
    [SPECIES_FLYGON] = 1,
    [SPECIES_MAKUHITA] = 2, // Monodramon
    [SPECIES_HARIYAMA] = 5, // Strikedramon
    [SPECIES_ELECTRIKE] = 1,// Elecmon
    [SPECIES_MANECTRIC] = 0,// Centarumon
    [SPECIES_NUMEL] = 1,
    [SPECIES_CAMERUPT] = 0,
    [SPECIES_SPHEAL] = 2,
    [SPECIES_SEALEO] = 2,
    ...
    [SPECIES_LUNATONE] = 1,
    [SPECIES_SOLROCK] = 0,
    [SPECIES_AZURILL] = 4, // Moonmon
    [SPECIES_SPOINK] = 0,
    [SPECIES_GRUMPIG] = 2,
    [SPECIES_PLUSLE] = 0,   // QueenChessmon
    [SPECIES_MINUN] = 0,    // KingChessmon
    [SPECIES_MAWILE] = 2,
    [SPECIES_MEDITITE] = 5, // Lopmon
    [SPECIES_MEDICHAM] = 5, // Antylamon
    [SPECIES_SWABLU] = 0,
    [SPECIES_ALTARIA] = 0,
    [SPECIES_WYNAUT] = 0,
    [SPECIES_DUSKULL] = 0,
    [SPECIES_DUSCLOPS] = 0,
    [SPECIES_ROSELIA] = 4,
    [SPECIES_SLAKOTH] = 2,  // Gazimon
    [SPECIES_VIGOROTH] = 2, // Leomon
    [SPECIES_SLAKING] = 5,  // MadLeomon
    [SPECIES_GULPIN] = 0,   // Pagumon
    [SPECIES_SWALOT] = 4,   // Raremon
    [SPECIES_TROPIUS] = 1,
    [SPECIES_WHISMUR] = 5, // Shoutmon
    [SPECIES_LOUDRED] = 0, // Shoutmon X2
    [SPECIES_EXPLOUD] = 2, // Shoutmon X3
    [SPECIES_CLAMPERL] = 0,
    [SPECIES_HUNTAIL] = 0,
    [SPECIES_GOREBYSS] = 0,
    [SPECIES_ABSOL] = 0,
    ...
    [SPECIES_BANETTE] = 0,
    [SPECIES_SEVIPER] = 2,
    [SPECIES_ZANGOOSE] = 5, // Wendigomon
    [SPECIES_RELICANTH] = 2,
    [SPECIES_ARON] = 3,     // Hagurumon
    [SPECIES_LAIRON] = 5,   // Guardromon
    [SPECIES_AGGRON] = 5,   // Andromon
    [SPECIES_CASTFORM] = 0,
    [SPECIES_VOLBEAT] = 0,
    [SPECIES_ILLUMISE] = 2,
    [SPECIES_LILEEP] = 2,
    ...
    [SPECIES_ANORITH] = 0,
    [SPECIES_ARMALDO] = 2,
    [SPECIES_RALTS] = 3,    // Puttimon
    [SPECIES_KIRLIA] = 3,   // Tapirmon
    [SPECIES_GARDEVOIR] = 0,// Starmon
    [SPECIES_BAGON] = 0,
    [SPECIES_SHELGON] = 2,
    [SPECIES_SALAMENCE] = 0,
    [SPECIES_BELDUM] = 0,
    ...
    [SPECIES_MAMOSWINE] = 2,
    [SPECIES_PORYGON_Z] = 0,
    [SPECIES_GALLADE] = 3,  // Seasarmon
    [SPECIES_PROBOPASS] = 3,// Knightmon
    [SPECIES_DUSKNOIR] = 2,
    [SPECIES_FROSLASS] = 0,
    [SPECIES_ROTOM] = 0,
    [SPECIES_UXIE] = 0,
    ...
    [SPECIES_POPPLIO] = 3,      // Syakomon
    [SPECIES_BRIONNE] = 5,      // Shellmon
    [SPECIES_PRIMARINA] = 2,    // Mermaimon
    [SPECIES_PIKIPEK] = 2,
    [SPECIES_TRUMBEAK] = 0,
    [SPECIES_TOUCANNON] = 0,
    [SPECIES_YUNGOOS] = 2,
    ...
    [SPECIES_STUFFUL] = 0,
    [SPECIES_BEWEAR] = 0,
    [SPECIES_BOUNSWEET] = 5,// Lalamon
    [SPECIES_STEENEE] = 1,  // Sunflowmon
    [SPECIES_TSAREENA] = 1, // Lilamon
    [SPECIES_COMFEY] = 1,
    [SPECIES_ORANGURU] = 0,
    [SPECIES_PASSIMIAN] = 1,
    [SPECIES_WIMPOD] = 2,
