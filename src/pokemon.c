...
void DoMonFrontSpriteAnimation(struct Sprite *sprite, u16 species, bool8 noCry, u8 panModeAnimFlag)
{
    ...
    else
    {
        ...
        if (GetSpeciesFrontAnimDelay(species) != 0)
        {
            ...
            gTasks[taskId].sAnimId = GetSpeciesFrontAnimSet(species);
            gTasks[taskId].sAnimDelay = GetSpeciesFrontAnimDelay(species);
        }
        else
        {
            // No delay, start animation
            LaunchAnimationTaskForFrontSprite(sprite, GetSpeciesFrontAnimSet(species));
        }
...
void PokemonSummaryDoMonAnimation(struct Sprite *sprite, u16 species, bool8 oneFrame)
{
    ...
    {
        // No delay, start animation
        StartMonSummaryAnimation(sprite, GetSpeciesFrontAnimSet(species));
    }
}
