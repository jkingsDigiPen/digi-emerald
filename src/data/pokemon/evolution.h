const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_CHARMANDER]            = {{EVO_LEVEL, 16, SPECIES_CHARMELEON}}, // agumon
    [SPECIES_CHARMELEON]            = {{EVO_LEVEL, 36, SPECIES_CHARIZARD}}, // geogreymon
    [SPECIES_CHARIZARD]             = {{EVO_MEGA_EVOLUTION, ITEM_CHARIZARDITE_X, SPECIES_CHARIZARD_MEGA_X}, // rizegreymon
    ...
    [SPECIES_JIGGLYPUFF]            = {{EVO_LEVEL, 32, SPECIES_WIGGLYTUFF}}, // gatomon
    [SPECIES_ZUBAT]                 = {{EVO_LEVEL, 22, SPECIES_GOLBAT}}, // demidevimon
    [SPECIES_GOLBAT]                = {{EVO_LEVEL, 38, SPECIES_CROBAT}}, // devimon
    [SPECIES_ODDISH]                = {{EVO_LEVEL, 21, SPECIES_GLOOM}}, // floramon
    [SPECIES_GLOOM]                 = {{EVO_ITEM, ITEM_LEAF_STONE, SPECIES_VILEPLUME}, // vegiemon
    ...
    [SPECIES_ABRA]                  = {{EVO_LEVEL, 16, SPECIES_KADABRA}}, // renamon
    [SPECIES_KADABRA]               = {{EVO_LEVEL, 36, SPECIES_ALAKAZAM}}, // kyubimon
    [SPECIES_ALAKAZAM]              = {{EVO_MEGA_EVOLUTION, ITEM_ALAKAZITE, SPECIES_ALAKAZAM_MEGA}},
    [SPECIES_MACHOP]                = {{EVO_LEVEL, 18, SPECIES_MACHOKE}}, // gaomon
    [SPECIES_MACHOKE]               = {{EVO_LEVEL, 32, SPECIES_MACHAMP}}, // gaogamon
    [SPECIES_BELLSPROUT]            = {{EVO_LEVEL, 21, SPECIES_WEEPINBELL}},
    [SPECIES_WEEPINBELL]            = {{EVO_ITEM, ITEM_LEAF_STONE, SPECIES_VICTREEBEL}},
    [SPECIES_TENTACOOL]             = {{EVO_LEVEL, 30, SPECIES_TENTACRUEL}}, // gesomon
    [SPECIES_GEODUDE]               = {{EVO_LEVEL, 25, SPECIES_GRAVELER}}, // gottsumon
    [SPECIES_GRAVELER]              = {{EVO_LEVEL, 35, SPECIES_GOLEM}}, // golemon
    ...
    [SPECIES_IGGLYBUFF]             = {{EVO_LEVEL, 15, SPECIES_JIGGLYPUFF}}, // salamon
    ...
    [SPECIES_MARILL]                = {{EVO_LEVEL, 27, SPECIES_AZUMARILL}}, // lunamon
    ...
    [SPECIES_SLUGMA]                = {{EVO_LEVEL, 32, SPECIES_MAGCARGO}, // Black Agumon
                                       {EVO_ITEM, ITEM_DUSK_STONE, SPECIES_TORKOAL}}, 
    ...
    [SPECIES_POOCHYENA]             = {{EVO_LEVEL, 18, SPECIES_MIGHTYENA}}, // dracmon
    [SPECIES_ZIGZAGOON]             = {{EVO_LEVEL, 20, SPECIES_LINOONE}}, // kudamon
    [SPECIES_WURMPLE]               = {{EVO_LEVEL_FEMALE, 7, SPECIES_SILCOON}, // minomon
                                       {EVO_LEVEL_MALE, 7, SPECIES_CASCOON}},
    [SPECIES_SILCOON]               = {{EVO_LEVEL, 15, SPECIES_BEAUTIFLY}}, // morphomon
    [SPECIES_CASCOON]               = {{EVO_LEVEL, 15, SPECIES_DUSTOX}}, // wormmon
    ...
    [SPECIES_CARVANHA]              = {{EVO_LEVEL, 26, SPECIES_SHARPEDO}},
    ...
    [SPECIES_MAKUHITA]              = {{EVO_LEVEL, 22, SPECIES_HARIYAMA}}, // monodramon
    [SPECIES_ELECTRIKE]             = {{EVO_LEVEL, 24, SPECIES_MANECTRIC}}, // elecmon
    [SPECIES_MANECTRIC]             = {{EVO_MEGA_EVOLUTION, ITEM_MANECTITE, SPECIES_MANECTRIC_MEGA}}, // centarumon
    ...
    [SPECIES_AZURILL]               = {{EVO_LEVEL, 14, SPECIES_MARILL}}, // moonmon
    [SPECIES_SPOINK]                = {{EVO_LEVEL, 32, SPECIES_GRUMPIG}},
    [SPECIES_MAWILE]                = {{EVO_MEGA_EVOLUTION, ITEM_MAWILITE, SPECIES_MAWILE_MEGA}},
    [SPECIES_MEDITITE]              = {{EVO_LEVEL, 37, SPECIES_MEDICHAM}, // lopmon
                                       {EVO_ITEM, ITEM_DUSK_STONE, SPECIES_ZANGOOSE}},
    ...
    [SPECIES_GULPIN]                = {{EVO_LEVEL, 24, SPECIES_SWALOT}}, // Pagumon
    ...
    [SPECIES_ARON]                  = {{EVO_LEVEL, 22, SPECIES_LAIRON}}, // hagurumon
    [SPECIES_LAIRON]                = {{EVO_LEVEL, 36, SPECIES_AGGRON}}, // guardromon
    ...
    [SPECIES_RALTS]                 = {{EVO_LEVEL, 15, SPECIES_KIRLIA}}, // puttimon
    ...
    [SPECIES_POPPLIO]               = {{EVO_LEVEL, 17, SPECIES_BRIONNE}}, // syakomon
    [SPECIES_BRIONNE]               = {{EVO_LEVEL, 34, SPECIES_PRIMARINA}}, // shellmon
    ...
    [SPECIES_BOUNSWEET]             = {{EVO_LEVEL, 17, SPECIES_STEENEE}}, // lalamon
    [SPECIES_STEENEE]               = {{EVO_LEVEL, 34, SPECIES_TSAREENA}}, // sunflowmon
