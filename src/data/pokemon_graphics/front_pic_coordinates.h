...
const struct MonCoords gMonFrontPicCoords[] =
{
    ...
    [SPECIES_SLUGMA] =
    {
        .size = MON_COORDS_SIZE(39, 61),
        .y_offset = 2,
    },
    // Monochromon
    [SPECIES_MAGCARGO] =
    {
        .size = MON_COORDS_SIZE(62, 45),
        .y_offset = 4,
    },
    [SPECIES_SWINUB] =
    {
