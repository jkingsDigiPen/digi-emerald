const u8 gSpeciesNames[][POKEMON_NAME_LENGTH + 1] = {
    ...
    [SPECIES_CHARMANDER] = _("Agumon"),
    [SPECIES_CHARMELEON] = _("GeoGreymon"),
    [SPECIES_CHARIZARD] = _("RzGreymon"),
    ...
    [SPECIES_JIGGLYPUFF] = _("Gatomon"),
    [SPECIES_WIGGLYTUFF] = _("Angewomon"),
    [SPECIES_ZUBAT] = _("DemiDevimn"),
    [SPECIES_GOLBAT] = _("Devimon"),
    [SPECIES_ODDISH] = _("Floramon"),
    [SPECIES_GLOOM] = _("Vegiemon"),
    [SPECIES_VILEPLUME] = _("Blossomon"),
    ...
    [SPECIES_ABRA] = _("Renamon"),
    [SPECIES_KADABRA] = _("Kyubimon"),
    [SPECIES_ALAKAZAM] = _("Taomon"),
    [SPECIES_MACHOP] = _("Gaomon"),
    [SPECIES_MACHOKE] = _("Gaogamon"),
    [SPECIES_MACHAMP] = _("MachGaogmn"),
    [SPECIES_BELLSPROUT] = _("Bellsprout"),
    [SPECIES_WEEPINBELL] = _("Weepinbell"),
    [SPECIES_VICTREEBEL] = _("Victreebel"),
    [SPECIES_TENTACOOL] = _("Gesomon"),
    [SPECIES_TENTACRUEL] = _("MarineDvmn"),
    [SPECIES_GEODUDE] = _("Gottsumon"),
    [SPECIES_GRAVELER] = _("Golemon"),
    [SPECIES_GOLEM] = _("Volcanomon"),
    [SPECIES_PONYTA] = _("Ponyta"),
    [SPECIES_RAPIDASH] = _("Rapidash"),
    [SPECIES_SLOWPOKE] = _("Slowpoke"),
    [SPECIES_SLOWBRO] = _("Slowbro"),
    [SPECIES_MAGNEMITE] = _("Kokuwamon"),
    [SPECIES_MAGNETON] = _("Mekanorimn"),
    ...
    [SPECIES_VOLTORB] = _("Terriermon"),
    [SPECIES_ELECTRODE] = _("Gargomon"),
    ...
    [SPECIES_GOLDEEN] = _("Gizamon"),
    [SPECIES_SEAKING] = _("Tortamon"),
    ...
    [SPECIES_MAGIKARP] = _("Numemon"),
    [SPECIES_GYARADOS] = _("MKimeramon"),
    ...
    [SPECIES_BELLOSSOM] = _("CeresmonMd"),
    [SPECIES_MARILL] = _("Lunamon"),
    [SPECIES_AZUMARILL] = _("Lekismon"),
    ...
    [SPECIES_SLUGMA] = _("BlackAgumn"),
    [SPECIES_MAGCARGO] = _("Monochromn"),
    ...
    [SPECIES_POOCHYENA] = _("Dracmon"),
    [SPECIES_MIGHTYENA] = _("Sangloupmn"),
    [SPECIES_ZIGZAGOON] = _("Kudamon"),
    [SPECIES_LINOONE] = _("Reppamon"),
    [SPECIES_WURMPLE] = _("Minomon"),
    [SPECIES_SILCOON] = _("Morphomon"),
    [SPECIES_BEAUTIFLY] = _("Hudiemon"),
    [SPECIES_CASCOON] = _("Wormmon"),
    [SPECIES_DUSTOX] = _("Stingmon"),
    [SPECIES_LOTAD] = _("Otamamon"),
    [SPECIES_LOMBRE] = _("Gekomon"),
    [SPECIES_LUDICOLO] = _("ShgnGkomon"),
    [SPECIES_SEEDOT] = _("Mushroomon"),
    [SPECIES_NUZLEAF] = _("Woodmon"),
    [SPECIES_SHIFTRY] = _("Cherrymon"),
    [SPECIES_TAILLOW] = _("Hawkmon"),
    [SPECIES_SWELLOW] = _("Aquilamon"),
    [SPECIES_WINGULL] = _("Falcomon"),
    [SPECIES_PELIPPER] = _("Crowmon"),
    [SPECIES_RALTS] = _("Puttimon"),
    [SPECIES_KIRLIA] = _("Tapirmon"),
    [SPECIES_GARDEVOIR] = _("Starmon"),
    [SPECIES_SURSKIT] = _("Hyokomon"),
    [SPECIES_MASQUERAIN] = _("Buraimon"),
    [SPECIES_SHROOMISH] = _("Kotemon"),
    [SPECIES_BRELOOM] = _("Shurimon"),
    [SPECIES_SLAKOTH] = _("Gazimon"),
    [SPECIES_VIGOROTH] = _("Leomon"),
    [SPECIES_SLAKING] = _("Mad Leomon"),
    [SPECIES_NINCADA] = _("Kunemon"),
    [SPECIES_NINJASK] = _("Flymon"),
    [SPECIES_SHEDINJA] = _("Shadramon"),
    [SPECIES_WHISMUR] = _("Shoutmon"),
    [SPECIES_LOUDRED] = _("ShoutmonX2"),
    [SPECIES_EXPLOUD] = _("ShoutmonX3"),
    [SPECIES_MAKUHITA] = _("Monodramon"),
    [SPECIES_HARIYAMA] = _("Strikedrmn"),
    [SPECIES_AZURILL] = _("Moonmon"),
    [SPECIES_NOSEPASS] = _("PawnChssmn"),
    [SPECIES_SKITTY] = _("Labramon"),
    [SPECIES_DELCATTY] = _("Cerberumon"),
    [SPECIES_SABLEYE] = _("Digitamamn"),
    [SPECIES_MAWILE] = _("Nefertimon"),
    [SPECIES_ARON] = _("Hagurumon"),
    [SPECIES_LAIRON] = _("Guardromon"),
    [SPECIES_AGGRON] = _("Andromon"),
    [SPECIES_MEDITITE] = _("Lopmon"),
    [SPECIES_MEDICHAM] = _("Antylamon"),
    [SPECIES_ELECTRIKE] = _("Elecmon"),
    [SPECIES_MANECTRIC] = _("Centarumon"),
    [SPECIES_PLUSLE] = _("KChessmon"),
    [SPECIES_MINUN] = _("QChessmon"),
    [SPECIES_VOLBEAT] = _("Volbeat"),
    [SPECIES_ILLUMISE] = _("Illumise"),
    [SPECIES_ROSELIA] = _("Roselia"),
    [SPECIES_GULPIN] = _("Pagumon"),
    [SPECIES_SWALOT] = _("Raremon"),
    [SPECIES_CARVANHA] = _("Tylomon"),
    [SPECIES_SHARPEDO] = _("Seahomon"),
    [SPECIES_WAILMER] = _("Wailmer"),
    [SPECIES_WAILORD] = _("Wailord"),
    [SPECIES_NUMEL] = _("Numel"),
    [SPECIES_CAMERUPT] = _("Camerupt"),
    [SPECIES_TORKOAL] = _("DkTyranomn"),
    ...
    [SPECIES_GALLADE] = _("Seasarmon"),
    [SPECIES_PROBOPASS] = _("Knightmon"),
    ...
    [SPECIES_FENNEKIN] = _("Renamon"),
    [SPECIES_BRAIXEN] = _("Kyubimon"),
    [SPECIES_DELPHOX] = _("Taomon"),
    ...
    [SPECIES_POPPLIO] = _("Syakomon"),
    [SPECIES_BRIONNE] = _("Shellmon"),
    [SPECIES_PRIMARINA] = _("Mermaimon"),
    ...
    [SPECIES_BOUNSWEET] = _("Lalamon"),
    [SPECIES_STEENEE] = _("Sunflowmon"),
    [SPECIES_TSAREENA] = _("Lilamon"),
    ...
    [SPECIES_CHARIZARD_MEGA_X] = _("WarGreymon"),
    [SPECIES_CHARIZARD_MEGA_Y] = _("ShineGrymn"),
    [SPECIES_BLASTOISE_MEGA] = _("Dianamon"),
    [SPECIES_BEEDRILL_MEGA] = _("TigrVspmon"),
    [SPECIES_PIDGEOT_MEGA] = _("Halsemon"),
    [SPECIES_ALAKAZAM_MEGA] = _("Sakuyamon"),
    [SPECIES_SLOWBRO_MEGA] = _("AMermaimon"),
    [SPECIES_GENGAR_MEGA] = _("Gengar"),
    [SPECIES_KANGASKHAN_MEGA] = _("Ravemon"),
    [SPECIES_PINSIR_MEGA] = _("Okuwamon"),
    [SPECIES_GYARADOS_MEGA] = _("Regalecsmn"),
    [SPECIES_AERODACTYL_MEGA] = _("Chirinmon"),
    [SPECIES_MEWTWO_MEGA_X] = _("Mewtwo"),
    [SPECIES_MEWTWO_MEGA_Y] = _("Eosmon"),
    [SPECIES_AMPHAROS_MEGA] = _("Rapidmon"),
    [SPECIES_STEELIX_MEGA] = _("Steelix"),
    [SPECIES_SCIZOR_MEGA] = _("Scizor"),
    [SPECIES_HERACROSS_MEGA] = _("Jewelbeemn"),
    [SPECIES_HOUNDOOM_MEGA] = _("Matadormon"),
    [SPECIES_TYRANITAR_MEGA] = _("Dinobeemon"),
    [SPECIES_SCEPTILE_MEGA] = _("Rosemon"),
    [SPECIES_BLAZIKEN_MEGA] = _("Blaziken"),
    [SPECIES_SWAMPERT_MEGA] = _("Swampert"),
    [SPECIES_GARDEVOIR_MEGA] = _("SuperStarmon"),
    [SPECIES_SABLEYE_MEGA] = _("Devitamamn"),
    [SPECIES_MAWILE_MEGA] = _("ASphinxmon"),
    [SPECIES_AGGRON_MEGA] = _("HighAndrmn"),
    [SPECIES_MEDICHAM_MEGA] = _("Cherubimon"),
    [SPECIES_MANECTRIC_MEGA] = _("Kentaursmn"),
    [SPECIES_SHARPEDO_MEGA] = _("Dragomon"),
    ...
    [SPECIES_LOPUNNY_MEGA] = _("MirageGgmn"),
    [SPECIES_GARCHOMP_MEGA] = _("Garchomp"),
    [SPECIES_LUCARIO_MEGA] = _("Cyberdramn"),
    [SPECIES_ABOMASNOW_MEGA] = _("SkullGrymn"),
    [SPECIES_GALLADE_MEGA] = _("Caturamon"),
    [SPECIES_AUDINO_MEGA] = _("Ophanimon"),
