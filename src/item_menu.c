...
struct TempWallyBag {
    ...
    struct ItemSlot bagPocket_Medicine[BAG_MEDICINE_COUNT]; // Bigger bag
...
void DoWallyTutorialBagMenu(void)
{
    ...
    GoToBagMenu(ITEMMENULOCATION_WALLY, ITEMS_MEDICINE, CB2_SetUpReshowBattleScreenAfterMenu2);
}
