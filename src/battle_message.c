...
static const u8 sText_UseNextPkmn[] = _("Use next Digimon?");
...
static const u8 sText_FaintInThree[] = _("All affected Digimon will\nfaint in three turns!");
...
static const u8 sText_YouMissedPkmn[] = _("You missed the Digimon!");
static const u8 sText_PkmnBrokeFree[] = _("Oh, no!\nThe Digimon broke free!");
...
static const u8 sText_PkmnsWillPerishIn3Turns[] = _("Both Digimon will perish\nin three turns!");
...
static const u8 sText_BothCanNoLongerEscape[] = _("Neither Digimon can run away!");
